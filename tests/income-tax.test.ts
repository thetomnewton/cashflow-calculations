...
describe('income tax', () => {
  test('basic rate salary is taxed correctly', () => {
    ...
    expect(outputIncomeYear.tax.ni_paid.class1).toEqual(round(27430 * 0.08, 2));

    expect(outputIncomeYear.net_value).toEqual(32319.6);
  });
  ...
  test('correct net values added to sweep account', () => {
    ...
    expect(out.incomes[salary.id].years[0].net_value).toEqual(54057.4);
